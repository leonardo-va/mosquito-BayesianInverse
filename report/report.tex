...
\dot{J}   &= \delta_E E - \alpha J^2 - \mu_J J - \delta_J J \\
\dot{S}_M &= \omega \delta_J J - a b_M \dfrac{S_M I_H}{N_H} - \mu_M S_M \\
\dot{E}_M &= a b_M \dfrac{S_M I_H}{N_H} - (\alpha_M + \mu_M) E_M \\
\dot{I}_M &= \alpha_M E_M - \mu_M I_M
\end{array}
\right. \\
\\
\text{Hosts} \quad
&\left\{
\begin{array}{rl}
\dot{S}_H  &= \Lambda - a b_H \frac{I_M S_H}{N_H} - \mu_H S_H \\
\dot{E}_H  &= a b_H \frac{I_M S_H}{N_H} - \alpha_H E_H - \mu_H E_H \\
